...
# from .apiviews import TaskList, TaskDetail,   TaskList2

""" class.as_view: call the function as view for do some work"""
urlpatterns = [
    ...
    path('datatable', TaskDataTable.as_view(), name='task_datatable'),

    # path('work-api', workWithApi, name='work-api'),
    # path('polls/', TaskList2.as_view(), name='api-polls'),
]
